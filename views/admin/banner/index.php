         ...
         <tbody>
            <?php foreach ($banners as $banner) : ?>
               <tr class="datarow">
                  ...
                  <td>
                     <div class="name">
                        <a href="index.php?opt=banner&cat=edit&id=<?= $banner->idl ?>">
                           <?= $banner->name; ?>
                        </a>
                     </div>
                     <div class="function_style">
                        <?php if ($banner->status == 1) : ?>
                           <a href="index.php?opt=banner&cat=status&id=<?= $banner->id; ?>" class="px-1 text-success">
                              <i class="fa fa-toggle-on"></i>
                           </a>
                        <?php else : ?>
                           <a href="index.php?opt=banner&cat=status&id=<?= $banner->id; ?>" class="px-1 text-danger">
